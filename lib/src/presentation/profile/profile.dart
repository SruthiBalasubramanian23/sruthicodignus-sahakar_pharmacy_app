                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: 15.w,),
                          Text("KMT Medicals",style: AppTheme.profilepageheadtext,)
                        ],
                      ),
                      ...
                      GestureDetector(
                        ...
                        child: Image.asset(AssetResources.exit,height: 16.h,width: 18.w,))
                    ],
                  ),
                  const Divider(
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  Text("Change password",style: AppTheme.greyishText,),
                  SizedBox(height: 5.h,),
                   TextController(
                      prefixicon: Padding(
                    ...
                    Text("Confirm Password",style: AppTheme.greyishText,),
                    SizedBox(height: 5.h,),
                    TextController(
                      prefixicon: Padding(
                        padding: const EdgeInsets.all(13.0),
                    ...
                    SaveButton(txt: "SAVE", onTap:() => Navigator.push(context,MaterialPageRoute(builder: (context)=>const BottomNavBarPage())),)
                ],
              ),
            ),
          )
