...
class DialogSecondAddCart extends StatelessWidget {
  final String medicine;
  final String quantitytxt;
  final String price;
  const DialogSecondAddCart(
      {super.key,
        ...
        title: Padding(
          ...
          child: Column(
            ...
            children: [Row(
              ...
              children: [
                Text(medicine,style: AppTheme.headingtext,),
                GestureDetector(
                  onTap: () {
            ...
            Text("Micro Lab Ltd",style: AppTheme.greyText,),
            SizedBox(height: 3.h,),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                ...
                Container(
                  ...
                  child: Text(quantitytxt,style: AppTheme.blacktext,textAlign:TextAlign.left ,),
                ),
              ],
            ),
             SizedBox(height: 8.h,),
            Row(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Image.asset(AssetResources.rupee,height: 18,),
                    SizedBox(width: 3.w,),
                    Text(price,style: AppTheme.blacktext,),
                  ],
                ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      SvgPicture.asset(AssetResources.cart),
                      GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder:(context)=>const AddCartSuccess()));
                        },
                        child: Text(" ADD CART",style: AppTheme.ratetext,)),
                    ],
                  ),
                )
              ],
